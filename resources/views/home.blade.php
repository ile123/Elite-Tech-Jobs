...
<footer class="text-white text-center text-lg-start bg-dark">
      ...
      <div class="row mt-4">
        ...
        <div class="col-lg-4 col-md-6 mb-4 mb-md-0">
          ...
          <ul class="fa-ul" style="margin-left: 1.65em;">
            <li class="mb-3">
              <span class="fa-li"><i class="fas fa-home"></i></span><span class="ms-2">Split, Croatia</span>
            </li>
            <li class="mb-3">
              <span class="fa-li"><i class="fas fa-envelope"></i></span><span class="ms-2">info@elite-tech-careers.com</span>
            </li>
            <li class="mb-3">
    ...
    <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
      © 2023 Copyright:
      <a class="text-white" href="https://mdbootstrap.com/">Elite Tech Careers</a>
    </div>
    <!-- Copyright -->
  </footer>
<style>
